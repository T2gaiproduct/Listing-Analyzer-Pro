  ...
  tutorials: [
    {
      ...
      fields: [
        { key: "tutorials.heading", label: "Section eyebrow (small label above headline)" },
        { key: "tutorials.showcase_line1", label: "Headline line 1 (white)" },
        { key: "tutorials.showcase_line2", label: "Headline line 2 (gradient)" },
        { key: "tutorials.showcase_body", label: "Body copy", type: "textarea", rows: 3 },
        { key: "tutorials.showcase_primary_text", label: "Primary button text" },
        { key: "tutorials.showcase_primary_url", label: "Primary button URL", type: "url" },
        { key: "tutorials.showcase_secondary_text", label: "Secondary link text" },
        { key: "tutorials.showcase_secondary_url", label: "Secondary link URL", type: "url" },
        { key: "tutorials.showcase_stat1_label", label: "Stat 1 label" },
        { key: "tutorials.showcase_stat1_value", label: "Stat 1 value" },
        { key: "tutorials.showcase_stat2_label", label: "Stat 2 label" },
        { key: "tutorials.showcase_stat2_value", label: "Stat 2 value" },
        { key: "tutorials.showcase_stat3_label", label: "Stat 3 label" },
        { key: "tutorials.showcase_stat3_value", label: "Stat 3 value" },
        { key: "tutorials.showcase_stat4_label", label: "Stat 4 label" },
        { key: "tutorials.showcase_stat4_value", label: "Stat 4 value" },
        { key: "tutorials.cta_text", label: "View all link text (legacy — section uses showcase CTAs)" },
