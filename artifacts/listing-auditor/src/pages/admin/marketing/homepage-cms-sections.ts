  ...
  workflow: [
    {
      ...
      fields: [
        ...
        { key: "workflow.before_label", label: "Before card label (all pairs)" },
        { key: "workflow.after_label", label: "After card label (all pairs)" },
        { key: "workflow.after_badge", label: "After badge text (all pairs)" },
      ],
    },
  ],
  tutorials: [
